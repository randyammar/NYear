...
namespace NYear.ODA
{
    public interface IODACmd
    {
        ...
        //ODACmd InnerJoin(ODACmd JoinCmd, params ODAColumns[] On);
        //bool Insert(ODACmd SelectCmd, params ODAColumns[] Cols);
        //bool Insert(params ODAColumns[] Cols);
        //ODACmd LeftJoin(ODACmd JoinCmd, params ODAColumns[] On);
        ...
        //ODACmd RightJoin(ODACmd JoinCmd, params ODAColumns[] On);
