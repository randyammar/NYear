...
namespace NYear.ODA.DevTool
{
    public partial class DBCopy : Form
    {
        ...
        //    if (TarDB != null)
        //    {
        //        DataTable srcTables = CurrentDatabase.DataSource.GetTableColumns();
        ...
        //            if (cbxCreateTable.Checked)
        //            {
        //                DataRow[] drs = srcTables.Select("TABLE_NAME ='" + TableName + "'");
        //                DatabaseColumnInfo[] ColumnInfo = new DatabaseColumnInfo[drs.Length];
        //                for (int j = 0; j < drs.Length; j++)
        //                {
        //                    ColumnInfo[j] = TarDB.ODAColumnToOrigin(drs[j]["COLUMN_NAME"].ToString(), drs[j]["ODA_DATATYPE"].ToString().Trim(), decimal.Parse(drs[j]["LENGTH"].ToString().Trim()));
        //                }
        //                CreateTable(TableName, ColumnInfo);
        //            }

        //            if (cbxTransData.Checked)
        //            {
        //                int total = 1001;
        //                int maxR = 1000;
        //                int startIndx = 0;
        //                do
        //                {
        //                    DataTable DT = CurrentDatabase.DataSource.Select(null, "SELECT * FROM " + TableName, null, startIndx, maxR, out total);
        //                    TransferData(DT, TableName);
        ...
        //private bool CreateTable(string TableName, DatabaseColumnInfo[] ColumnInfo)
        //{
        //    try
        //    {
        //        string dropSQL = "DROP TABLE " + TableName;
        //        TarDB.ExecuteSQL(null, dropSQL, null);
        //    }
        //    catch { }
        ...
        //        TarDB.ExecuteSQL(null, creatSQL.ToString(), null);
        //    }
        //    catch { }
        //    return true;
        //}

        //private bool TransferData(DataTable Source, string ToTable)
        //{
        //    DataTable trgTables = TarDB.GetTableColumns();
        //    DataRow[] drs = trgTables.Select("TABLE_NAME ='" + ToTable + "'");

        //    string TransID = TarDB.BeginTransaction(9999);
        //    try
        //    {
        //        string insertSQL = "INSERT INTO " + ToTable;
        //        string col = "";
        //        string iprms = "";
        //        string paramMark = TarDB.ParamsMark;
        ...
        //                Oprms[c].ParamsValue = Source.Rows[i][drs[c]["COLUMN_NAME"].ToString()];
        //            }
        //            TarDB.ExecuteSQL(null, insertSQL, Oprms);
        //        }
        //        TarDB.Commit(TransID);
        //        return true;
        //    }
        //    catch
        //    {
        //        TarDB.RollBack(TransID);
        //        return false;
        //    }
        //}
