...
namespace NYear.ODA
{
    ...
    public partial class ODACmd
    {
        public dynamic SelectDynamicFirst(params ODAColumns[] Cols)
        {
            int total = 0;
        ...
        public List<dynamic> SelectDynamic(params ODAColumns[] Cols)
        {
        ...
        public List<dynamic> SelectDynamic(int StartIndex, int MaxRecord, out int Total, params ODAColumns[] Cols)
        {
