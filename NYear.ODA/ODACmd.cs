...
namespace NYear.ODA
{
    public class ODACmd : IDBScriptGenerator
    {
        ...
        private T ChangeType<T>(int idx, object[] val) where T : IConvertible
        {
            return DBAccess.ChangeType<T>(idx, val);
        }
        ...
        public T0 SelectFirst<T0>(params ODAColumns[] Cols)
            where T0 : IConvertible
        {
            object[] items = this.SelectFirst(Cols);
            return ChangeType<T0>(0, items);
        }
           ...
           where T1 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1> rtl = new Record<T0, T1>(
           ...
           where T2 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2> rtl = new Record<T0, T1, T2>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
            ...
            where T3 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3> rtl = new Record<T0, T1, T2, T3>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                 ChangeType<T2>(2, items),
            ...
            where T4 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4> rtl = new Record<T0, T1, T2, T3, T4>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T5 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5> rtl = new Record<T0, T1, T2, T3, T4, T5>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T6 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6> rtl = new Record<T0, T1, T2, T3, T4, T5, T6>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T7 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T8 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7, T8> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7, T8>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T9 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T10 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T11 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T12 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T13 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T14 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
        ...
        where T15 : IConvertible
        {
            ...
            if (items == null)
                return null;
            Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> rtl = new Record<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(
                ChangeType<T0>(0, items),
                ChangeType<T1>(1, items),
                ChangeType<T2>(2, items),
                ChangeType<T3>(3, items),
